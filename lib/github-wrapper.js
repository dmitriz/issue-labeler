...
/**
 * Ensures a GitHub API path segment contains only allowed characters.
 *
 * Validates that the provided segment includes only alphanumeric characters, dashes, underscores, or periods to prevent path traversal vulnerabilities.
 *
 * @param {string} segment - The path segment to validate.
 * @returns {string} The validated segment.
 *
 * @throws {Error} If {@link segment} contains characters other than alphanumerics, dashes, underscores, or periods.
 */
